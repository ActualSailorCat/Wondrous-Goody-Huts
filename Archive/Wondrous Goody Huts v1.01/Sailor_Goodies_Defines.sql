...
VALUES	('GOODYHUT_SAILOR_RANDOMRESOURCE',		13), -- Random resource granted.
		('GOODYHUT_SAILOR_RANDOMUNIT',			13), -- Random unit granted.
		('GOODYHUT_SAILOR_RANDOMIMPROVEMENT',	13), -- Random improvement granted.
		('GOODYHUT_SAILOR_SIGHTBOMB',			12), -- Map of the area.
		('GOODYHUT_SAILOR_RANDOMPOLICY',		12), -- Random policy granted.
		('GOODYHUT_SAILOR_FORMATION',			12), -- Unit formation upgraded.
		('GOODYHUT_SAILOR_WONDER',				13), -- Unit moved to undiscovered wonder.
		('GOODYHUT_SAILOR_CITYSTATE',			12); -- Meet unmet city-state.
...
--// 6 Formation
INSERT INTO GoodyHutSubTypes (GoodyHut, SubTypeGoodyHut, Description, Weight, ModifierID, UpgradeUnit, Turn, Experience, Heal, Relic, Trader, MinOneCity, RequiresUnit)
SELECT	'GOODYHUT_SAILOR_WONDROUS', 'GOODYHUT_SAILOR_FORMATION', 'LOC_GOODYHUT_SAILOR_FORMATION', Weight, 'SAILOR_GOODY_FORMATION', 0, 0, 0, 0, 0, 0, 0, 0
