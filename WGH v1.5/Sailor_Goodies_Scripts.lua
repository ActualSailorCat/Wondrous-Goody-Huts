...
local tHutties = {
	{Hash = 1999084244,		Name = "RESOURCE",     Func = WGH_Resource},
    {Hash = 1625079733,		Name = "UNIT",         Func = WGH_Unit},
    {Hash = -2106477136,	Name = "IMPROVEMENT",  Func = WGH_Improvement},
    {Hash = -1461129027,	Name = "SIGHT",        Func = WGH_Sight},
    {Hash = 260349556,		Name = "FORMATION",    Func = WGH_Formation},
    {Hash = 1157765560,		Name = "POLICY",       Func = WGH_Policy},
    {Hash = -2028412409,	Name = "WONDER",       Func = WGH_Wonder},
    {Hash = 1379672131,		Name = "CITYSTATE",    Func = WGH_CityState},
    {Hash = -2099557375,	Name = "SPY",          Func = WGH_Spy},
    {Hash = 913875234,		Name = "PRODUCTION",   Func = WGH_Production},
    {Hash = -861896920,		Name = "TELEPORT",     Func = WGH_Teleport}
};

function Sailor_WGH(playerID, unitID, goodytype, subgoodytype)
	...
	for _, hut in ipairs(tHutties) do
		if hut.Hash == subgoodytype then
			print("Wondrous Goody Activated:", hut.Hash, hut.Name);
			local bSuccess = hut.Func(playerID, iX, iY, unit, unitAbility);
			if not bSuccess then -- Random unique as fallback if reward can't be granted for any reason.
				WGH_Unit(playerID, iX, iY);
